        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "ShowAndTell.McConf API V1");
                    options.OAuthAppName("ShowAndTell.McConf API");
